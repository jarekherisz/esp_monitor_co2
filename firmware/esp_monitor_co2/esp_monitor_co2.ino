...
void setupDisplay()
{
  ...
  { // Używanie stałej OLED_ADDRESS
    Serial.println(F("Nie można zainicjować SSD1306"));
    for (;;)
      ; // Zatrzymanie działania programu, jeśli nie można zainicjować wyświetlacza
  }
...
void setupSCD4x()
{
  ...
  if (mySensor.begin() == false)
  {
    ...
    while (1)
      ; // Zawieszenie programu, jeśli czujnik nie zostanie wykryty
  }
    ...
    <body>
      ...
      <script>
        ...
        ws.onmessage = function(event) {
          ...
          document.getElementById('values').innerHTML = `CO2: ${data.CO2} ppm<br>Temperature: ${data.Temperature} *C<br>Humidity: ${data.Humidity} %`;
        };
      </script>
    </body>
    </html>
